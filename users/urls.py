...
urlpatterns = [
    ...
    path('create_advert',views.advert_form,name='create_advert'),
    ...
    # path('company_subscribe',views.CompanySellersSubscribeView.as_view(),name='company_sellers_subscribe'),
